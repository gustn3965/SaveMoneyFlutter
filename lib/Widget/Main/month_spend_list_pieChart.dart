...
class PieChart2State extends State {
  ...
  List<Indicator> makeIndicatorWidget(SaveMoneyViewModel saveMoneyViewModel) {
    return saveMoneyViewModel.monthSpendModels.map((e) => Indicator(color: e.color, text: e.categoryName, isSquare: true)).toList();
  }

  List<PieChartSectionData> showingSections(SaveMoneyViewModel saveMoneyViewModel) {
