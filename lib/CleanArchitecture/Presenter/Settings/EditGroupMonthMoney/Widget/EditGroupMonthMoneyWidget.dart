...
class EditGroupMonthMoneyWidget extends StatelessWidget {
  final EditGroupMonthMoneyViewModel viewModel;

  String _formatNumber(String s) => NumberFormat("#,###").format(int.parse(s));
  late TextEditingController groupMoneyTitleController = TextEditingController();
  EditGroupMonthMoneyWidget(this.viewModel, {super.key}) {
    viewModel.dataStream.listen((event) {
      groupMoneyTitleController.text =
          NumberFormat("#,###").format(event.plannedBudget);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<EditGroupMonthMoneyViewModel>(
